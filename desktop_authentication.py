...
def main(client_secrets_path, scopes):
    ...
    print(f"Access Toker:{flow.credentials.token}")
    print(f"Refresh Toker:{flow.credentials.refresh_token}")

    credentials = {"access_token": flow.credentials.token, "refresh_token": flow.credentials.refresh_token}
